...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.date_selector_income_expense.setGeometry(QRect(138, 240, 91, 22))
        self.sql_tableview = QTableView(self.income_expense)
        self.sql_tableview.setObjectName(u"sql_tableview")
        self.sql_tableview.setGeometry(QRect(398, 100, 351, 341))
        ...
        self.back_to_summary_income_expense_button.setGeometry(QRect(200, 410, 131, 32))
        ...
        self.update_balances_button.setGeometry(QRect(600, 470, 121, 32))
        ...
        self.days_spinbox.setGeometry(QRect(170, 410, 42, 22))
        ...
        self.apr_rate_entry_field.setGeometry(QRect(170, 290, 111, 21))
        ...
        self.back_to_summary_bank_account_button.setGeometry(QRect(190, 470, 131, 32))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.stackedWidget.setToolTip(QCoreApplication.translate("MainWindow", u"Toman", None))
...
#if QT_CONFIG(tooltip)
        self.amount_entry_field.setToolTip(QCoreApplication.translate("MainWindow", u"Toman", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.date_selector_bank.setDisplayFormat(QCoreApplication.translate("MainWindow", u"mm/dd/yyyy", None))
